...
module top ;
    ...
    SwSPI_Master_v1_10_3 SwSPI_Master ();

    SCB_P4_v3_20_4 UART_XB (
        .cts_in(1'b0),
        .tx_out(Net_122),
        .rts_out(Net_123),
        .interrupt(Net_124),
	...
	wire [0:0] tmpOE__debug_pulse_clock_net;
	wire [0:0] tmpIO_0__debug_pulse_clock_net;
	wire [0:0] tmpINTERRUPT_0__debug_pulse_clock_net;
	electrical [0:0] tmpSIOVREF__debug_pulse_clock_net;

	cy_psoc3_pins_v1_10
		#(.id("44122e60-6b4a-43eb-ac04-ddcd32d8f089"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		debug_pulse_clock
		 (.oe(tmpOE__debug_pulse_clock_net),
		  .y({1'b0}),
		  .fb({Net_289}),
		  .io({tmpIO_0__debug_pulse_clock_net[0:0]}),
		  .siovref(tmpSIOVREF__debug_pulse_clock_net),
		  .interrupt({tmpINTERRUPT_0__debug_pulse_clock_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__debug_pulse_clock_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
